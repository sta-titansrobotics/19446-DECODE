...
public class Constants {
    public static FollowerConstants followerConstants = new FollowerConstants()
            ...
            .translationalPIDFCoefficients(new PIDFCoefficients(0.05, 0.00001, 0.01, 0.002))
            .secondaryTranslationalPIDFCoefficients(new PIDFCoefficients(0.1,0,0.02,0.009))
            .headingPIDFCoefficients(new PIDFCoefficients(2, 0, 0, 0))
            .secondaryHeadingPIDFCoefficients(new PIDFCoefficients(0.4,0,0.01,0.0))
