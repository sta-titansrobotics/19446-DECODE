...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_Y = -3.625; // X is the up and down direction
    public static double PARALLEL_X = 5; // Y is the strafe direction

    public static double PERPENDICULAR_Y = 3.5;
    public static double PERPENDICULAR_X = 5.5;

    public static double X_MULTIPLIER = 1; // Multiplier in the X direction (actual over reported)
    public static double Y_MULTIPLIER = 1; // Multiplier in the Y direction (actual over reported)
