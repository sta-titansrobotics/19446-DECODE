...
public class JanComp extends LinearOpMode {
        ...
        while (opModeIsActive()) {
          ...
          //  rotpreverr = (rottarg - getDeg());
            ...
            if (gamepad1.dpad_down) {
                rottarg = Math.toRadians(180);
            }
            if (gamepad1.dpad_left) {
                rottarg = Math.toRadians(90);
            }
            ...
            if (gamepad1.right_stick_y != 0 || gamepad1.right_stick_x != 0 || gamepad1.left_stick_x != 0 || roterr > 0.3 || roterr < -0.3){
    ...
    private double getAngle()
    {
        ...
        if (deltaAngle < -(180*(180/pi)))
            deltaAngle += (360*(180/pi));
        else if (deltaAngle > (180*(180/pi)))
            deltaAngle -= (360*(180/pi));
